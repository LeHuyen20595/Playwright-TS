...
import AddEmployeeComponent from "./components/pim-component.ts/add-employee-component";
import EmployeeListComponent from "./components/pim-component.ts/employee-list-component";

class PIMPage{
  constructor(private page: Page){};

  addEmployeeComponent = new AddEmployeeComponent(this.page);
  employeeListComponent = new EmployeeListComponent(this.page);

  getAddEmployeeComponent(){
    return this.addEmployeeComponent;
  }

  getEmployeeListComponent(){
    return this.employeeListComponent;
  }
}
